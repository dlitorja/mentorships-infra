...
- `CONVEX_HTTP_KEY` set (the low-risk Inngest workers + admin routes + the admin-onboarding flow all authenticate against this bearer; see [`convex/http.ts`](../../../../convex/http.ts)).
