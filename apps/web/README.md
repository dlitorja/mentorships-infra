...
Build notes: Convex codegen runs during install. Ensure `CONVEX_DEPLOY_KEY` and `CONVEX_DEPLOYMENT` are set for Preview and Production environments in Vercel.
